export const GUEST_DATA = {
  ...
  summary: {
    ...
    urgent: { category: 'Urgent', amount: 1, deadline: 'No' },
  ...
  tasks: [
    ...
    },
    {
      ...
      description:
        'Enable real-time data exchange by using Firestore Snapshots.',
      assignedTo: [
        {
          id: 'g81A8pSrM5FXwa3C6t8P',
          initials: 'EF',
      ...
      subtasks: [
        {
          id: 0,
          text: 'Subscribe user collection',
          done: true,
          focused: false,
        },
